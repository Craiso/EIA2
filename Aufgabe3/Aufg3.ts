...
namespace Aufgabe3 {
    ...
    let imgData: ImageData; //Variable für Bildabspeicherung Hintergrund
    ...
    function createSkifahrer(x: number, y: number): void {
    ...
    function animate(): void {
        crc2.clearRect(0, 0, 800, 600); //löscht alles
        ...
        //Skifahrer
        for (let i: number = 0; i < skierY.length; i++) {
