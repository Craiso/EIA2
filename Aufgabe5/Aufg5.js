...
(function (L06_Class) {
    ...
    function init() {
        ...
        for (var i = 0; i < 5; i++) {
            var s = new L06_Class.Ski(-i * 20, i * 10 + 100, (i * Math.random()) + 4); //let s neue variable Objekt Skifahrer wird reingespeichert
        ...
        for (var i = 0; i < 5; i++) {
            var t = new L06_Class.Baume(((i + 1) * Math.random()) * 100 + 200, ((i + 1) * Math.random()) * 100 + 400);
            baumen[i] = t;
        }
        hintergrund = new L06_Class.Hintergrund(0, 0, 0); //�bergabe von werten + farbe (farbe war test wegen problemen)
